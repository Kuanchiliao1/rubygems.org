...
class PusherTest < ActiveSupport::TestCase
  ...
  context "creating a new gemcutter" do
    ...
    should "not be able to save a gem if the dependencies are not resolvable" do
      ...
      assert_match(/Cannot publish gem. The following dependencies don't exist: non-existent-gem/, @cutter.message)
      assert_equal 422, @cutter.code # Not sure what code to use here
    end
  ...
  context "checking if the rubygem can be pushed to" do
    ...
    context "with unresolvable dependencies" do
      should "not be able to push gem" do
        ...
        assert_equal "Cannot publish gem. The following dependencies don't exist: non-existent-gem", @cutter.message
        assert_equal 422, @cutter.code
      end
    end
  end
